...
router.patch("/:id/approve", validateAuth, requireActive, checkSuperAdmin, activateUser) // superadmin can upgrade a pending user to active
router.patch("/:id/ban", validateAuth, requireActive, checkSuperAdmin, banUser) // superadmin can ban a user
